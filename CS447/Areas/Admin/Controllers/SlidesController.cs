...
namespace CS447.Areas.Admin.Controllers
{
    public class SlidesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,Content,Link,Image,Status")] Slide slide)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,Content,Link,Image,Status")] Slide slide)
        {
            if (ModelState.IsValid)
            {
